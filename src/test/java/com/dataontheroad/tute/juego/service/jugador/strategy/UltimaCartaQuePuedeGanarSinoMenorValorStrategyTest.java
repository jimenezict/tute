...
class UltimaCartaQuePuedeGanarSinoMenorValorStrategyTest {

    Ronda ronda;
    UltimaCartaQuePuedeGanarSinoMenorValorStrategy strategy = new UltimaCartaQuePuedeGanarSinoMenorValorStrategy();
    Jugador jugador;
    Carta cartaMuestra;
